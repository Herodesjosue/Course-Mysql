...
SELECT MOD(4,2);
-- funcion de modulo para obtener el residuo de la division entre 5 y 2
SELECT MOD(5,2);
-- lo sube al numero inmediato
SELECT CEILING(7.1);
-- lo bajo al numero inmediato
SELECT FLOOR(7.9);
-- redondear un numero
SELECT ROUND(7.5);
SELECT ROUND(7.4999);
--elevar a la potencia con la funcion power
SELECT POWER(2, 6);
-- obtener la raiz cuadra sqrt
SELECT SQRT(81);
...
-- HAVING SE UTILIZA MAS QUE TODO PARA CONDICIONAR LA COLUMNA CALCULADA QUE SERIA EN ESTE CASO "AS PRECIO_MAXIMO"
...
-- ORDENA DE FORMA ASC = ASCENDENTE
SELECT * FROM caballeros ORDER BY nombre ASC;
-- ORDENA DE FORMA DESC = DESCENDENTE
